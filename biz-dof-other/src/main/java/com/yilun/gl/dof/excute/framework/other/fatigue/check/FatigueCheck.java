package com.yilun.gl.dof.excute.framework.other.fatigue.check;
...
import com.yilun.gl.dof.excute.framework.other.fatigue.FatiguePeriodTypeEnum;
...
public abstract class FatigueCheck {
    ...
    protected Pair<Long, List<Long>> getAccumTimeArray(AccumSummaryEntity accumSummary, AccumWithTime accumWithTime, RuleTimeConfig ruleTimeConfig, Long currentTime) {
        ...
        if (Objects.equals(fatiguePeriodType, FatiguePeriodTypeEnum.MINUTE.getCode())) {
        ...
        } else if (Objects.equals(fatiguePeriodType, FatiguePeriodTypeEnum.HOUR.getCode())) {
        ...
        } else if (Objects.equals(fatiguePeriodType, FatiguePeriodTypeEnum.DAY.getCode())) {
        ...
        } else if (Objects.equals(fatiguePeriodType, FatiguePeriodTypeEnum.WEEK.getCode())) {
        ...
        } else if (Objects.equals(fatiguePeriodType, FatiguePeriodTypeEnum.MONTH.getCode())) {
        ...
        } else if (Objects.equals(fatiguePeriodType, FatiguePeriodTypeEnum.YEAR.getCode())) {
        ...
        } else if (Objects.equals(fatiguePeriodType, FatiguePeriodTypeEnum.QUARTER.getCode())) {
            return null;
        }
        return null;
    }
