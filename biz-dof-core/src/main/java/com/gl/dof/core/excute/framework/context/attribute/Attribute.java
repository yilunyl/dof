...
public interface Attribute<T> {
     ...
     * {@link io.netty.util.AttributeMap} use {@link #getAndSet(Object)} with a value of {@code null}.
     *
     * <p>
     * Be aware that even if you call this method another thread that has obtained a reference to this {@link Attribute}
     * via {@link io.netty.util.AttributeMap#attr(io.netty.util.AttributeKey)} will still operate on the same instance. That said if now another
     * thread or even the same thread later will call {@link io.netty.util.AttributeMap#attr(io.netty.util.AttributeKey)} again, a new
     ...
     * {@link io.netty.util.AttributeMap} use {@link #set(Object)} with a value of {@code null}.
     *
     * <p>
     * Be aware that even if you call this method another thread that has obtained a reference to this {@link Attribute}
     * via {@link io.netty.util.AttributeMap#attr(io.netty.util.AttributeKey)} will still operate on the same instance. That said if now another
